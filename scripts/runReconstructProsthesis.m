...
% matfON = matfile('../dat/spikeResp_prosthesis_on_parasol');

% disp('Loading OFF parasol spike responses')
% % matfOFF = matfile('../dat/spikeResp_may26_off.mat');
matfON = matfile('/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/spikeResp_prosthesis_stixds4_short6');
...
load('/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/movie_prosthesis_stixds4_short6')
...
fileext = 'on_parasol_short6';
[filters]=linearReconstructSVD(stim,matfON.spikeResp,fileext, windowsize);

% disp('Training OFF only filters...')
% %load OFF parasols
% fileext = 'off_parasol_prosthesis';
% [filters]=linearReconstructSVD(stim,matfOFF.spikeResp,fileext, windowsize);
...
%   sta{i} = avg-0.5;
% end
% figure; imagesc(reshape(sta{i}(:,1),80,40)); axis image
