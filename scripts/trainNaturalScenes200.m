function [mosaicFile, saveFile] = trainNaturalScenes200(varargin)
%
...
%     filenameRGC = [reconstructionRootPath '/dat/ns200/' mosaicFile '.mat'];
...
%           load([ reconstructionRootPath  '\dat\imagenetBlocks\movsm_' num2str(blockNum) '.mat'],'movsm');
    natScenes = movsm(1:200,1:200,randperm(nSteps));
...
%     filename1 = [reconstructionRootPath '/dat/nsResponses/' saveFile '_block_' num2str(blockNum) '.mat'];
    if ismac || isunix
        filename1 = [reconstructionRootPath '/dat/ns200/' saveFile '_block_' num2str(blockNum) '_' mosaicFile '.mat'];
    else
        filename1 = [reconstructionRootPath '\dat\ns200/' saveFile '_block_' num2str(blockNum) '_' mosaicFile '.mat'];
    end
