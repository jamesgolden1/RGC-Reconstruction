...
folderNameTest = 'sep22gratingsContAdd';
...
freqArr =2;%[2 4 8.0000 12 16.0000   18.1595   20.6104   23.3921   26.5493   30.1326   34.1995 38.8153  42 44.0541  47 50.0000];
...
%     reconGratings.buildGratings('nTrials',100,'contrast',contrastArr(contrastInd),'gratingSpFreq',10);
     ...
     reconGratings.buildGratings('nTrials',200,'contrast',contrastArr(contrastInd),'gratingSpFreq',freqArr(freqInd),'horizontalFlag',hFlag, pRecon);
end
    end
% delete(gcp);
% contrastArr =  [0 .1]
