...
contrastArr = 8e-4;%1*[0 .0001 .001 .008 .01 .0125 .015 .0175 .02 .0225 .025 .0275 .03 .05 .1 .15 ];
...
freqArr = [freqArr 0.5 .75 1 6 10 12.5 13 13.5 14 14.5 15.5 16.5 17 17.5 19 21];
% dirname = 'gratings_sep17/prima_sep17/';
dirname1 = 'healthy_gratings_aug16_cont_08long';
dirname2 = 'healthy_gratings_aug16_nocont_08long';
numReps =4 ;
...
load(fullfile(['/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/' dirname1],[sprintf('recon_freqH%4d_cont%6d.mat',100*freqArr(freqInd),1e5*contrastArr(contrastInd))]),'trialReconPlay','contrast','spikeTrials');
...
load(fullfile(['/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/' dirname2],[sprintf('recon_freq%4d_cont%6d.mat',100*freqArr(freqInd),1e5*contrastArr(contrastInd))]),'trialReconPlay','contrast','spikeTrials');
...
% figure; subplot(131); imagesc(reshape(dataRaw(:,10),[100 100])); colormap gray
% subplot(132); imagesc(reshape(dataRaw(:,200+10),[100 100])); colormap gray;
% 
% subplot(133); imagesc(reshape(dataRaw(:,10)-dataRaw(:,200+10),[100 100])); colormap gray;
%%
