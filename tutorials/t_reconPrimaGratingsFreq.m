...
dirname1 = 'prosthesis_70_gratings_aug24_cont';
dirname2 = 'prosthesis_70_gratings_aug24_nocont'; freqArr = [.5 1 1.5 2 2.5 3 3.5 4 4.5 5 5.5 6 6.5 7 7.5 12];

numReps =16;

maxTrial = 200;%size(framesOut,3);
...
% filterMat = load('/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/aug29prima70/filtersmosaic0_sv50_w1_sh15_dr0_zero05.mat')
...
% 
% figure; subplot(121); imagesc(reshape(mean(dataRaw(:,1:200),2),[100 100])); colormap gray
% subplot(122); imagesc(reshape(mean(dataRaw(:,200+[1:200]),2),[100 100])); colormap gray
%%
...
% load('ws_gratings_primaOnlyOn_aug24_2018_8reps_out0.mat');
% load('ws_gratings_primaLearning_aug24_2018_16reps_out0.mat');
% load('ws_gratings_primaOnlyOn_aug24_2018_16reps_out0.mat');
...
hold on;
for radVal = 1%1:15
    plot(freqArrSort(:),Pbigsort(sortInd),'-go','linewidth',4);
end
