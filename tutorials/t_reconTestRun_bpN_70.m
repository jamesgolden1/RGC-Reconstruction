...
for bipolarNoise = [.1 .3 .7 .9]

pixelWidth = 70/1;

folderName = ['prosthesis_70_testing_aug13_bpN_oct24_n' sprintf('%.0f',100*bipolarNoise) ];
% folderName = 'prosthesis_70_testing_aug13_bpN_oct24_n2'; 
...
pRecon.bipolarNoise = bipolarNoise;
