...
folderName = ['prosthesis_' num2str(pwid) '_testing_aug13_bpN_oct24_n' sprintf('%.0f',100*bipolarNoise) '_dr30'];
load(['/Volumes/Lab/Users/james/current/RGC-Reconstruction/dat/' folderName '/' resultsName '/stats_' num2str(ii) '.mat']);
