...
contrastArr = 1;%1*[0 .0001 .001 .008 .01 .0125 .015 .0175 .02 .0225 .025 .0275 .03 .05 .1 .15 ];
freqArr = sqrt([ .01 .1 .2 .3 .35 .4 .45 .5 .55 .6 .65 .7 .75 .8 .875 1]);
% dirname = 'gratings_sep17/prima_sep17/';
dirname1 = 'august_cont1/prosthesis_70_landolt_aug16_nogap';
dirname2 = 'august_cont1/prosthesis_70_landolt_aug16_gap';
numReps =4 ;
...
load(fullfile(['/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/' dirname1],[sprintf('primaRecon_freqH%4d_cont%6d_rs%2d.mat',100*25,1e5*contrastArr(contrastInd),100*freqArr(freqInd))]),'trialReconPlay','contrast','spikeTrials');
...
load(fullfile(['/Users/james/Documents/MATLAB/RGC-Reconstruction/dat/' dirname2],[sprintf('primaRecon_freq%4d_cont%6d_rs%2d.mat',100*25,1e5*contrastArr(contrastInd),100*freqArr(freqInd))]),'trialReconPlay','contrast','spikeTrials');
