...
folderNameTest = 'sep17prima70landoltFreq';
...
%      reconPrimaLandolt.buildPrimaGratings('nTrials',400,'contrast',contrastArr(contrastInd),'gratingSpFreq',freqArr(freqInd),'horizontalFlag',hFlag,pRecon);
        reconPrimaLandolt.buildPrimaLandolt('nTrials',100,'contrast',contrastArr(contrastInd),'gap',gap,'resizeFraction',resizeArr(resizeInd),pRecon);   
end
end
delete(gcp);
